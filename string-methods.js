...
let lastCharFruit = fruit.length - 1;
let lastCharVegetable = vegetable.length - 1;

console.log("Fruit: "+fruit.charAt(lastCharFruit));
console.log("Vegetable: "+vegetable.charAt(lastCharVegetable));
...
let result = story.split("Fantastisch")
